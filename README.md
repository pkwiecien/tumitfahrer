...
*GET* | `/rides?ride_type=0` | get all the rides of specific ride_type. 0 => campus , 1 => activity
*GET* | `/rides?ride_type=0&page=0` | get all the rides of specific ride_type with specific page. 0 => campus , 1 => activity
