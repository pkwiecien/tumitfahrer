class RidesController < ApplicationController
  ...
  def create
    ...
    if @ride.save
      ...
      @notification = Grocer::Notification.new(device_token:"f4f382b537d663af6256649e412fc19110cbbdc3d80c04373c090a623810127e",alert: rideInfo,  badge:42, sound:"siren.aiff",  expiry: Time.now + 60*60,  identifier:1234, content_available: true)
